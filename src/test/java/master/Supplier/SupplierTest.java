...
public class SupplierTest extends TestBase {
    ...
    public void SupplierTest()throws Exception{
        ...
        MethodBase.setText_ByID("supplier_name","names"); // Supplier name
        MethodBase.setText_ByID("supplier_company_name","company names");// Company name
        ...
        MethodBase.setText_ByID("supplier_email","ravii@gmail.com");// Supplier Email
